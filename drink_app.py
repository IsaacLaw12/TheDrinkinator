...
class DrinkApp():
    ...
    def full_update(self):
        ...
        self.settings_ingredient_select_one["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_ingredient(self.settings_ingredient_selected_one, "Empty Slot", "slot_one"))
        self.settings_ingredient_select_two["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_ingredient(self.settings_ingredient_selected_two, "Empty Slot", "slot_two"))
        self.settings_ingredient_select_three["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_ingredient(self.settings_ingredient_selected_three, "Empty Slot", "slot_three"))
        self.settings_ingredient_select_four["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_ingredient(self.settings_ingredient_selected_four, "Empty Slot", "slot_four"))
        ...
        self.settings_drink_select_one["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_recipe_ingredient(self.settings_drink_selected_one, "Empty Slot"))
        self.settings_drink_select_two["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_recipe_ingredient(self.settings_drink_selected_two, "Empty Slot"))
        self.settings_drink_select_three["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_recipe_ingredient(self.settings_drink_selected_three, "Empty Slot"))
        self.settings_drink_select_four["menu"].add_command(label="Empty Slot", command = lambda ingredient = ingredient: self.set_recipe_ingredient(self.settings_drink_selected_four, "Empty Slot"))
