...
class Message_Handler():
    ...
    def fireMessage(self, receiver=self.intended_receiver, dictionary):
        '''
        Format: dictionary should have format {"request_type": "request_x", "request_data" : "..."}
        ...
        self.pubnub.publish().channel(serverChannel).message({'id': receiver, 'data': json_content}).async(self.DrinkMachinePublishCallback)
